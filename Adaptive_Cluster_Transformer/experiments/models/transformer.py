...
class Transformer(nn.Module):
    ...
    def __init__(self, d_model=512, nhead=8, num_encoder_layers=6,
                 ...
                 return_intermediate_dec=False, group_Q=True, 
                 group_K=False, q_hashes=32, k_hashes=8):
        super().__init__()

        encoder_layers = _get_clones(TransformerEncoderLayer(d_model, nhead, 
                                dim_feedforward, dropout, activation, normalize_before, 
                                group_Q, group_K, q_hashes, k_hashes), num_encoder_layers)
...
class TransformerEncoderLayer(nn.Module):
    ...
    def __init__(self, d_model, nhead, dim_feedforward=2048, dropout=0.1,
                 activation="relu", normalize_before=False, 
                 group_Q=True, group_K=False, q_hashes=32, k_hashes=32):
        super().__init__()
        self.self_attn = AdaMultiheadAttention(d_model, nhead, 
                group_Q, group_K, q_hashes, k_hashes, dropout=dropout)
